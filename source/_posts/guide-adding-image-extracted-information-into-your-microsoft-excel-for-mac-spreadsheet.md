...
date: 2024-08-27 23:12:13
updated: 2024-08-29 11:23:10
tags:
  - excel
categories:
  - tech
...
* [Step 1: Obtain the Data](https://android-pokemon-go.techidaily.com/the-most-useful-tips-for-pokemon-go-ultra-league-on-oppo-f23-5g-drfone-by-drfone-virtual-android/)
* [Step 2: Review and Insert the Data](https://on-screen-recording.techidaily.com/updated-googles-proven-technique-for-accurate-speech-conversion/)

 No one enjoys manually entering tons of data from printed material into a Microsoft Excel spreadsheet. You can save time, reduce the risk of errors, and eliminate a tedious task with the Data From Picture feature.
 ...
 Currently, this feature is available in Excel for Mac, iPhone, and Android. There's no word yet on when Windows users will get to join in the fun.

##  Step 1: Obtain the Data

 You can use one of three methods to insert the data into Microsoft Excel: an image file, an image that you copied to your clipboard, or your iPhone or iPad camera.
...
###  Insert Data from an Image File
 ...
 Open your spreadsheet in Excel and head to the Insert tab. Click "Data From Picture," and then select "Picture From File."
...
###  Insert Data from Your Clipboard
 ...
 After capturing the image to your clipboard, go to Excel's Insert tab, click "Data From Picture" on the ribbon, and then select "Picture From Clipboard."

![Click Data From Picture and pick Picture From Clipboard](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2021/05/PictureFromClipboard-ExcelMac.png) 
...
###  Insert Data from Your iPhone Camera
 ...
 Right-click a cell in the Excel spreadsheet and move down to "Insert from iPhone or iPad" in the menu. In the pop-out, click "Scan Documents" for your device.
...
![Data From Picture Sidebar in Excel](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2021/05/DataFromPictureSidebar-ExcelMac.png) 
 ...
 Excel highlights any questionable values for you to review and correct as needed. You'll see the data that Excel believes is accurate in the review box, along with its location in the image itself.

 You can click a particular piece of highlighted data to correct and then accept it.
...
---
 ...
 The next time you need to capture data from a website or printed piece, remember this handy trick for Microsoft Excel on Mac. And for speeding up other tasks, [learn how to use Excel macros for automation](https://win-blog.techidaily.com/troubleshooting-how-to-fix-failed-minecraft-installs-on-windows-11/).
